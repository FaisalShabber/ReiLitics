  ...
  render() {
    ...
    const columns = [
        ...
        title: () => {
          return (
            <div className="text-uppercase">
              Overall Average Appreciation{" "}
              <Tooltip
                placement="top"
                color="#E8F2FF"
                title="Estimated average property appreciation 2018-present"
              >
                <Button className="info_class">
                  <Info />
                </Button>
          ...
          return (
            <div className="text-uppercase">
              ...
              <Tooltip
                placement="top"
                color="#E8F2FF"
                title="Estimated median sales price of a property"
              >
                <Button className="info_class">
                  {" "}
                  <Info />
      ...
      },
      {
        ...
        width: "13%",
        render: (record, text, index) => (
          <>{Math.round(record.avgTax * 100) / 100}%</>
        ),
        // filters: [
        //   { text: 'London', value: 'London' },
        //   { text: 'New York', value: 'New York' },
