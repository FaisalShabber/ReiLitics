      ...
      },
      {
        title: () => {
          return <div className="text-uppercase">Overall Average Appreciation{' '}
            <Tooltip placement="top" color='#E8F2FF' title='Estimated average property appreciation 2018-present'>
            ...
            <div className='container mx-auto mt-3 px-md-5' >
              ...
              <div className='d-flex my-3'>
                ...
                <div className='ms-auto my-auto'>
                  <button className='btn btn-orange px-4 fs-14' onClick={this.print}>Print</button>
                  <CSVLink
