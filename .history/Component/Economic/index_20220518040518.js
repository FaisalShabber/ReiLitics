    ...
    <div>
      ...
      <div className="d-flex my-3">
        ...
        <div className="ms-auto my-auto">
          <button
            onClick={() => window.open("https://www.zillow.com/")}
            className="btn btn-orange px-4 fs-14 m-1"
          >
          ...
          {user.packageID == "shuihshsu" ? (
            ...
            <>
              <button className="btn btn-orange px-4 fs-14 m-1">
                Add to Favourite{" "}
                <img src="/unfilledHeart1.svg" className="ms-2 my-auto" />
              </button>
              <button className="btn btn-orange px-4 fs-14 m-1" onClick={print}>
                Print and Download
                <img src={"/print.svg"} className="ms-2 my-auto" />
              </button>
            </>
      ...
      <div className="Economic_pg">
        ...
        <footer className="text-center mt-5">
          <p>
            DISCLAIMER - Data is provided “as is” via the Public Records API.
          </p>
