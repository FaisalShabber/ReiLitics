...
class FilterAprecation extends React.Component {
  state = {
    filteredInfo: null,
    sortedInfo: null,
    data: [],
    ...
    response.then((value) => {
      if (value) {
        ...
        filter = filter.filter(
          (props) => props.avgTax < this.props.router.query.tax
        );
              ...
              <div className="my-3 d-flex">
                <div className="my-auto ms-auto">
                  <button
                    ...
                    onClick={this.print}
                    disabled={(this.state.packageName === "Free" || this.state.packageName === '' || this.state.packageName === undefined)}
                  >
                    Print
                  </button>
                  <CSVLink
                    ...
                    style={(this.state.packageName === "Free" || this.state.packageName === '' || this.state.packageName === undefined) ? { opacity: '0.7', pointerEvents: 'none' } : {}}
                    disabled={(this.state.packageName === "Free" || this.state.packageName === '' || this.state.packageName === undefined)}
                  >
                    Download CSV
                  </CSVLink>
...
export default withRouter(withAuth(FilterAprecation));
